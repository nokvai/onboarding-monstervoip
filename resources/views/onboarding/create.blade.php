<form id="onboardingForm" class="forms-sample" autocomplete="off" action="/onboarding/store" method="post">
    ...
    <tr id="createNew">
        ...
        <td>
            <input type="email" id="email_address" class="form-control" name="email_address" placeholder="Email Address" autocomplete="off" required>
        </td>
        <td>
            <input type="text" id="first_name" class="form-control" name="first_name" placeholder="First Name" autocomplete="off" required>
        </td>
        <td>
            <input type="text" id="last_name" class="form-control" name="last_name" placeholder="Last Name" autocomplete="off" required>
        </td>
        <td>
            <input type="text" id="voicemail_pin" class="form-control" name="voicemail_pin" placeholder="Voicemail PIN" autocomplete="off" required>
        </td>
        <td>
            <input type="text" id="portal_username" class="form-control" name="portal_username" placeholder="Portal Username" autocomplete="off" required>
        </td>
        <td>
            <input type="text" id="portal_password" class="form-control" name="portal_password" placeholder="Portal Password" autocomplete="off" required>
        </td>
        <td>
            <input type="text" id="phone_model" class="form-control" name="phone_model" placeholder="Phone Model" autocomplete="off">
        </td>
        <td>
            <input type="text" id="mac_address" class="form-control" name="mac_address" placeholder="MAC Address" autocomplete="off">
        </td>
        <td>
        ...
        <td>
            <button id="confirmButton" class="btn btn-primary">Save</button>
            <script>
                $(document).ready(function() {
