...
<body>
    <div>
        ...
        <div>
            ...
            <p style="text-align: center; color: #000; font-size: 18px; font-weight: 800;">
                Please add your business name on the URL:
                <br />
                <br />
                <small>
                    Example: <br />
                    <em>http://onboarding.monstervoip.com/onboarding/index/<b>my company</b></em>
                </small>
            </p>
